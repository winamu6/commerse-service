...
from payment_service.src.schemas import PaymentUpdate
...
class CachedPaymentWriter:
    ...
    async def cached_create_payment(self, payment: PaymentCreate) -> PaymentResponse:
    ...
    async def cached_update_payment(self, payment_id: int, update_data: PaymentUpdate) -> Optional[PaymentResponse]:
